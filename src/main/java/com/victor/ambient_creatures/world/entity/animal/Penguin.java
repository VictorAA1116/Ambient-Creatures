...
import com.victor.ambient_creatures.world.entity.ai.goal.WanderInWaterGoal;
import com.victor.ambient_creatures.world.entity.client.penguin.PenguinMoveControl;
import com.victor.ambient_creatures.world.entity.client.penguin.PenguinSwimNavigation;
...
public class Penguin extends Animal
{
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(7, new TryFindLiquidGoal(this, FluidTags.WATER));
