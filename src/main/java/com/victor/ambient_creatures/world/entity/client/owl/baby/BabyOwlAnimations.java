...
public class BabyOwlAnimations
{
    ...
    public static final AnimationDefinition FLYING = AnimationDefinition.Builder.withLength(0.3333F).looping()
            ...
            .addAnimation(PartNames.LEFT_WING, new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(-0.25F, -0.75F, 1.25F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.3333F, KeyframeAnimations.posVec(-0.25F, -0.75F, 1.25F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation(PartNames.RIGHT_WING, new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-57.5001F, 32.5F, 90.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.0833F, KeyframeAnimations.degreeVec(-43.7989F, 29.7622F, 116.157F), AnimationChannel.Interpolations.LINEAR),
